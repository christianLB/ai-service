...
export function setupContractRoutes(app: Express) {
  // Casts avoid strict contract typing until real aggregated contract is wired
  createExpressEndpoints(
    apiContract as any,
    {
      // Financial endpoints
      financial: {
        listAccounts: async (args: any) => {
          const { query: _query } = args as any;
          try {
        ...
        listAttachments: async (args: any) => {
        ...
        uploadAttachment: async (args: any) => {
          const { params: _params, body: _body } = args as any;
          try {
        ...
        downloadAttachment: async (args: any) => {
          const { params, query } = args as any;
          try {
            const userId = query.userId || 'anonymous';
      ...
      dashboard: {
        ...
        cashFlowProjections: async (args: any) => {
          const { query: _query } = args as any;
          try {
