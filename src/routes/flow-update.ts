        ...
        messages: [
          {
            role: 'system',
            content:
              'You are updating an existing n8n workflow. Preserve the structure and only modify what was requested.',
          },
          { role: 'user', content: prompt },
          {
            role: 'assistant',
            content: `Current workflow: ${JSON.stringify(existingWorkflow.workflow_data)}`,
          },
        ],
      });
