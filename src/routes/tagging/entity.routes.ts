...
import { aiRateLimit, standardRateLimit } from '../../middleware/express-rate-limit.middleware';
...
router.post(
  ...
  async (req: Request, res: Response, _next: NextFunction) => {
    try {
      ...
      const result = await entityTaggingService.tagEntity(entityType, entityId, request, userId);
...
router.delete(
  ...
  async (req: Request, res: Response, _next: NextFunction) => {
    try {
      ...
      await entityTaggingService.removeEntityTag(entityType, entityId, tagId, userId);
...
router.get(
  ...
  async (req: Request, res: Response, _next: NextFunction) => {
    try {
      ...
      const entityTaggingService = getEntityTaggingService();
      const result = await entityTaggingService.findEntitiesByTag(tagId, entityTypes, pagination);
