...
const logger = new Logger('MarketDataPrismaService');
...
export class MarketDataPrismaService {
  private static instance: MarketDataPrismaService;
  ...
  static getInstance(): MarketDataPrismaService {
    if (!MarketDataPrismaService.instance) {
      MarketDataPrismaService.instance = new MarketDataPrismaService();
    }
    return MarketDataPrismaService.instance;
  }
...
export const marketDataPrismaService = MarketDataPrismaService.getInstance();