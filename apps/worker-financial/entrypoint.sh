...
# ============================================================================
# Financial Worker Service Entrypoint - F5 Enhanced Version
# ============================================================================
# Features:
...
try {
  const env = getEnv('worker-financial');
  console.log('✅ Environment validation successful');
  console.log('  NODE_ENV:', env.NODE_ENV);
  console.log('  PORT:', env.PORT || 3101);
...
# ============================================================================
# Step 3: Wait for Redis (Critical for BullMQ)
# ============================================================================
...
while [ $i -lt $RETRIES ]; do
  if nc -z "$REDIS_HOST" "$REDIS_PORT" 2>/dev/null; then
    echo "[$SERVICE_NAME] ✅ Redis is ready (critical for job queue processing)"
    break
  fi
  i=$((i+1))
...
# ============================================================================
echo "[$SERVICE_NAME] Ensuring database schemas exist (financial, public, tagging)..."
...
# ============================================================================
echo "[$SERVICE_NAME] Starting worker on port ${PORT:-3101}..."
echo "[$SERVICE_NAME] Environment: ${NODE_ENV:-development}"
echo "[$SERVICE_NAME] Queue processing: financial-operations"
echo "[$SERVICE_NAME] Job types: invoice-generation, client-sync, transaction-categorization"
echo "[$SERVICE_NAME] ============================================"
