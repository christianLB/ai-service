 ...
 * Usage: node scripts/test-claude-integration.js
 */
...
async function testClaude() {
  try {
    ...
    // Import the services
    const { claudeAIService } = await import('../dist/services/ai/claude.service.js');
    const { tradingBrainService } = await import('../dist/services/trading/trading-brain.service.js');
