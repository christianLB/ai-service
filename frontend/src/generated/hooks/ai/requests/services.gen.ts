...
import type { ListTagsData, ListTagsResponse, CreateTagData, CreateTagResponse, SearchTagsData, SearchTagsResponse, GetTagData, GetTagResponse, UpdateTagData, UpdateTagResponse, DeleteTagData, DeleteTagResponse, GetEntityTagsData, GetEntityTagsResponse, TagEntityData, TagEntityResponse, UpdateEntityTagData, UpdateEntityTagResponse, RemoveEntityTagData, RemoveEntityTagResponse, FindEntitiesByTagData, FindEntitiesByTagResponse, BatchTagEntitiesData, BatchTagEntitiesResponse, ReTagEntitiesData, ReTagEntitiesResponse, ProvideTaggingFeedbackData, ProvideTaggingFeedbackResponse, GetTaggingLearningStatsResponse, SendTelegramMessageData, SendTelegramMessageResponse, SetTelegramWebhookData, SetTelegramWebhookResponse, GetTelegramChatInfoData, GetTelegramChatInfoResponse, SetIntegrationConfigData, SetIntegrationConfigResponse, ListConfigsByTypeData, ListConfigsByTypeResponse, GetIntegrationConfigData, GetIntegrationConfigResponse, DeleteIntegrationConfigData, DeleteIntegrationConfigResponse, AnalyzeDocumentAiData, AnalyzeDocumentAiResponse, CategorizeTextAiData, CategorizeTextAiResponse, ExtractEntitiesAiData, ExtractEntitiesAiResponse } from './types.gen';
...
export class EntityTaggingService {
     ...
     * @throws ApiError
     */
    public static updateEntityTag(data: UpdateEntityTagData): CancelablePromise<UpdateEntityTagResponse> {
        return __request(OpenAPI, {
            method: 'PATCH',
     ...
     * @throws ApiError
     */
    public static removeEntityTag(data: RemoveEntityTagData): CancelablePromise<RemoveEntityTagResponse> {
        return __request(OpenAPI, {
            method: 'DELETE',
            url: '/entities/{entityType}/{entityId}/tags/{tagId}',
            path: {
     ...
     * @throws ApiError
     */
    public static findEntitiesByTag(data: FindEntitiesByTagData): CancelablePromise<FindEntitiesByTagResponse> {
        return __request(OpenAPI, {
            method: 'GET',
     ...
     * @throws ApiError
     */
    public static batchTagEntities(data: BatchTagEntitiesData): CancelablePromise<BatchTagEntitiesResponse> {
        return __request(OpenAPI, {
            method: 'POST',
     ...
     * @throws ApiError
     */
    public static provideTaggingFeedback(data: ProvideTaggingFeedbackData): CancelablePromise<ProvideTaggingFeedbackResponse> {
        return __request(OpenAPI, {
            method: 'POST',
...
export class TelegramService {
     ...
     * @throws ApiError
     */
    public static sendTelegramMessage(data: SendTelegramMessageData): CancelablePromise<SendTelegramMessageResponse> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/telegram/send',
            body: data.requestBody,
     ...
     * @throws ApiError
     */
    public static setTelegramWebhook(data: SetTelegramWebhookData): CancelablePromise<SetTelegramWebhookResponse> {
        return __request(OpenAPI, {
            method: 'POST',
     ...
     * @throws ApiError
     */
    public static getTelegramChatInfo(data: GetTelegramChatInfoData): CancelablePromise<GetTelegramChatInfoResponse> {
        return __request(OpenAPI, {
            method: 'GET',
...
export class IntegrationConfigService {
     ...
     * @throws ApiError
     */
    public static setIntegrationConfig(data: SetIntegrationConfigData): CancelablePromise<SetIntegrationConfigResponse> {
        return __request(OpenAPI, {
            method: 'POST',
     ...
     * @throws ApiError
     */
    public static listConfigsByType(data: ListConfigsByTypeData): CancelablePromise<ListConfigsByTypeResponse> {
        return __request(OpenAPI, {
            method: 'GET',
     ...
     * @throws ApiError
     */
    public static getIntegrationConfig(data: GetIntegrationConfigData): CancelablePromise<GetIntegrationConfigResponse> {
        return __request(OpenAPI, {
            method: 'GET',
     ...
     * @throws ApiError
     */
    public static deleteIntegrationConfig(data: DeleteIntegrationConfigData): CancelablePromise<DeleteIntegrationConfigResponse> {
        return __request(OpenAPI, {
            method: 'DELETE',
            url: '/integrations/config/{type}/{key}',
            path: {
...
export class AiOperationsService {
     ...
     * @throws ApiError
     */
    public static analyzeDocumentAi(data: AnalyzeDocumentAiData): CancelablePromise<AnalyzeDocumentAiResponse> {
        return __request(OpenAPI, {
            method: 'POST',
     ...
     * @throws ApiError
     */
    public static categorizeTextAi(data: CategorizeTextAiData): CancelablePromise<CategorizeTextAiResponse> {
        return __request(OpenAPI, {
            method: 'POST',
     ...
     * @throws ApiError
     */
    public static extractEntitiesAi(data: ExtractEntitiesAiData): CancelablePromise<ExtractEntitiesAiResponse> {
        return __request(OpenAPI, {
            method: 'POST',
