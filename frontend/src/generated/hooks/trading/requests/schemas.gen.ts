...
export const $CreateTradeRequest = {
    type: 'object',
    ...
    properties: {
        ...
        strategyId: {
            type: 'string',
            description: 'Associated trading strategy'
        },
        notes: {
            type: 'string',
...
export const $UpdateTradeRequest = {
    ...
    properties: {
        quantity: {
            type: 'number',
            minimum: 0,
            description: 'Updated trade quantity'
        },
        price: {
            type: 'number',
            minimum: 0,
            description: 'Updated trade price'
        },
        fee: {
            type: 'number',
            minimum: 0,
            description: 'Updated trading fee'
        },
        notes: {
            type: 'string',
            description: 'Updated notes about the trade'
        }
    }
} as const;
...
export const $UpdatePositionRequest = {
    ...
    properties: {
        quantity: {
            type: 'number',
            minimum: 0,
            description: 'Updated position size'
        },
        stopLoss: {
            type: 'number',
            minimum: 0,
        ...
        takeProfit: {
            type: 'number',
            minimum: 0,
            description: 'Updated take profit price'
        }
    }
} as const;
...
export const $TradeListResponse = {
    type: 'object',
    required: ['success', 'data', 'pagination'],
    properties: {
        success: {
